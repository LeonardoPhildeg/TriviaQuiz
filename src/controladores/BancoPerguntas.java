...
public class BancoPerguntas {
    ...
    void instanciarPerguntas() {
        ...
        Pergunta p_geografia4 = new Pergunta(Tema.GEOGRAFIA, "Qual o nome do meridiano que separa o planeta em parte oriental e ocidental?", "Meridiano de Leakey", "Meridiano de Bering", "Meridiano de Crasring", "Meridiano de Greenwich", 4);
        geografia[4] = p_geografia4;
        Pergunta p_geografia5 = new Pergunta(Tema.GEOGRAFIA, "Em qual estado e região se localiza as cidades Água Branca, Souza e João Pessoa?", "Centro-Oeste (Bahia-BH)", "Sudeste (São Paulo SP)", "Nordeste (Paraíba PB)", "Nenhuma das alternativas", 3);
        ...
        Pergunta p_geografia7 = new Pergunta(Tema.GEOGRAFIA, "Onde fica o Monte Everest?", "Himalaia", "China", "Rússia", "Peru", 4);
        ...
        Pergunta p_esportes12 = new Pergunta(Tema.ESPORTES, "Qual dos seguintes times já foi considerado o pior do mundo?", "Santos", "Paysandu", "XV de Novembro", "Íbis", 1);
        ...
        Pergunta p_ciencias10 = new Pergunta(Tema.CIENCIAS, "Qual destes elementos, junto com o estanho, é a base para produção do bronze?", "Prata", "Ferro", "Cobre", "Alumínio", 3);
        ...
        ingles[9] = p_ingles9;
        Pergunta p_ingles10 = new Pergunta(Tema.INGLES, "O que significa \"drive home\" na frase \"The newspapers drive home the fact that violence is part of urban life\"?", "Dar o recado", "Dirigir para casa", "Revelar", "Abordar", 1);
        ...
        Pergunta p_ingles12 = new Pergunta(Tema.INGLES, "Complete a frase \"Two occasions of ____ declining activity were registered last year.\"", "disastrously", "disastrous", "disastering", "disaster", 1);
        ...
        Pergunta p_ingles14 = new Pergunta(Tema.INGLES, "Complete a frase \"I don't remember ___.\"", "what her name is", "her name is what", "is her name what", "what is her name", 4);
        ...
        Pergunta p_entretenimento16 = new Pergunta(Tema.ENTRETENIMENTO, "Qual filme possui o bordão \"Que a força esteja com você\"", "Power Rangers", "Jornada nas Estrelas", "O Poderoso Chefão", "Guerra nas Estrelas", 2);
        ...
        Pergunta p_entretenimento19 = new Pergunta(Tema.ENTRETENIMENTO, "Qual destas não é uma música do Michael Jackson?", "Remember The Time", "Dirty Diana", "Human Nature", "She Loves You", 2);
