...
public class BancoPerguntas {
    ...
    void instanciarPerguntas() {
        ...
        Pergunta p_ciencias7 = new Pergunta(Tema.CIENCIAS, "Quantos ossos possui o corpo humano?", "206", "256", "306", "356", 2);
        ciencias[7] = p_ciencias7;
        Pergunta p_ciencias8 = new Pergunta(Tema.CIENCIAS, "Qual é o nome comum do ácido ascórbico?", "Vitamina A", "Vitamina B", "Vicamina C", "Paracetamol", 3);
